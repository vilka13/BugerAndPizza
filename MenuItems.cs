...
namespace Restauracja_FasbiersPizza
{
    ...
    {
        public static class MainMenuItems //Menu glowny
        {
        ...
        public static class BurgerKindsMenuItems //classa burgers
        {   
        ...
        public static void CreateMenu(List<(int index, string itemName, decimal price)> myList) //Zastasowanie menu
        {
            for (int i = 0; i < myList.Count; i++)
            {
                if (myList[i].itemName.ToLower() == "burgery" || myList[i].itemName.ToLower() == "pizzy" || myList[i].itemName.ToLower() == "napoj" 
                    ...
                    || myList[i].itemName.ToLower() == "usuwanie pozycji")
                {
